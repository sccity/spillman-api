withCredentials([file(credentialsId: 'kubeconfig', variable: 'KUBECONFIG')]) {
    ...
    ./kubectl --kubeconfig $KUBECONFIG set image deployment/$DEPLOYMENT spillman-api=sccity/spillman-api:$commit_hash -n spillman
    ...
    ./kubectl --kubeconfig $KUBECONFIG rollout status deployment/$DEPLOYMENT -n spillman
